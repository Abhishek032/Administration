    ...
    <g:each in="${company}" var="companyObj" status="i">
        <div class="col-sm-12" style="background-color: #f2f2f2; padding: 5px 0 5px 0; border:1px solid white">
            <div class="col-sm-2" style="padding-left:0px; padding-right:0px">
                <div class="col-sm-1" style=" padding: 0 0 0 10px"align="center"><input type="radio" id="ohrmList_chkSelectRecord_1" name="radio" value="${companyObj.id}"></div>
            ...
            <div class="col-sm-2" style="padding: 0 0 0 10px;">${companyObj.getEmployee().size()}</div>
