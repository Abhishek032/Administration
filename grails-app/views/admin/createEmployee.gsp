...
<head>
    ...
    <title>HRM | ${company.companyName} Create Employee</title>
<g:javascript>
    var userCheck=true;
    var req = true;
    function act(){
...
<body>
    <div class="col-md-12">
        ...
        <div class="col-md-12" style="background-color: #f28c38; color: white ">
            <h1 style="text-align:left;font-size:20px;font-family:Verdana ">${company.companyName} Employee Creation</h1>
        </div>
        <div>
                ...
                <g:form name="employeeForm" url="[controller:'admin', action:'saveEmployee']">
                    ...
                    <div class="col-md-12" style="padding: 10px 0 10px 0" >
                        ...
                        <div class="col-md-6" style="padding: 5px">
                            ...
                            <div class="col-md-8">
                                <select class="inputStyle" name="role">
                                    <%if(role!=null){
