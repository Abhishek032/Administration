...
<head>
    ...
    <title>HRM | ${company.companyName} ${module.moduleName}</title>
</head>
<body>
...
<div class="col-md-12">
    ...
    <div class="col-md-12" style="background-color: #f28c38; color: white "><h1 style="text-align:left;font-size:20px;font-family:Verdana ">${company.companyName} | ${module.moduleName}</h1></div>
    <div>
    ...
    <div class="col-md-12" style="padding: 10px 0 10px 0; background-color: #f7f6f6; border-radius: 5px">
        <div class="col-md-4">
            <div class="col-md-5"><h4 style="color: #666666; margin-bottom: 0px" >Name</h4></div>
            <div class="col-md-7" style="padding-top: 10px">${module.moduleName}</div>
        </div>
        <div class="col-md-4" >
            <div class="col-md-5"><h4 style="color: #666666; margin-bottom: 0px">Type</h4></div>
            <div class="col-md-7" style="padding-top: 10px" >${module.moduleType}</div>
        </div>
        <div class="col-md-4" >
            <div class="col-md-5"><h4 style="color: #666666; margin-bottom: 0px">Date Created</h4></div>
            <div class="col-md-7" style="padding-top: 10px">${module.moduleCreated}</div>
        </div>
    </div>
</div>
