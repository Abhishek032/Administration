...
<head>
    ...
    <title>Administration | Create Module</title>
</head>
<body>
...
<div align="center">
    <h2 style="margin-top: 5px;margin-bottom: 5px">Create Module</h2>
    <g:form name="compForm" url="[controller:'module', action:'saveModule']">
        <input type="text" placeholder="Module Name" required name="moduleName" >
        <input type="text" placeholder="Module Type" required name="moduleType" >
        <input type="date" required name="moduleCreated">
...
<div class="col-md-12">
    ...
    <div class="col-md-12" style="background-color: #f28c38; color: white ">
        <h1 style="text-align:left;font-size:20px;font-family:Verdana ">Module Creation</h1></div>
    <div>
    ...
    <div class="box, col-md-12" style="border-radius:5px; background-color: #f7f6f6; padding-top: 15px; padding-bottom: 15px">
        <div class="inner" style="font-size:20px;height: auto">
            <g:form name="moduleForm" url="[controller:'module', action:'saveModule']">
                ...
                <div class="col-md-12" style="padding: 10px 0 10px 0" >
                    ...
                    <div class="col-md-6" style="padding: 5px">
                        ...
                        <div class="col-md-8">
                            <input class="inputStyle" type="date" required name="moduleCreated">
                        </div>
                    </div>
                </div>
